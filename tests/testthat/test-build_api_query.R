test_that(
  "Place names with spaces in get processed correctly", {
    expect_identical(
      ...
      "https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/LAD20_CAUTH20_EN_LU/FeatureServer/0/query?where=%20(CAUTH20NM%20=%20'GREATER%20MANCHESTER')%20&outFields=LAD20CD,LAD20NM,CAUTH20CD,CAUTH20NM&resultType=standard&f=json"
    )
  }
)
