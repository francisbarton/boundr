...
pull_geo_query_url <- function(geo_code_field, resolution, geo_option = 1) {
  ...
  msg <- "No result was found for the parameters supplied. Try a different year or a different resolution?"  %>% 
    stringr::str_wrap(72)
